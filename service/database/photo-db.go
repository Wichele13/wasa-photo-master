...
// RemovePhoto removes a photo from the database
...
// GetPhotos returns all photos uploaded by a user
...
// GetPhotosCount returns the number of photos a user has uploaded
...
// CheckPhoto checks if a photo exists in the database
